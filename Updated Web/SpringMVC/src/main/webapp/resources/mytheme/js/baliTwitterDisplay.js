...
function addTweet(tweet){
	...
	var tweetscreenname = tweet.doc.user.name;
	var tweetusername = tweet.doc.user.screen_name;
	var profileimage = tweet.doc.user.profile_image_url_https;
	...
	$('#bali-twitter-feed').append('<div>'+feedHTML +'</div>');
