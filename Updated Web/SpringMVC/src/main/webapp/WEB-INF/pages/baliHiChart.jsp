...
<script src="<c:url value="/resources/js/baliHiChart.js" />"></script>
<script src="<c:url value="/resources/js/baliPiChart.js" />"></script>
<script src="<c:url value="/resources/js/baliHiChartDuration.js" />"></script>
